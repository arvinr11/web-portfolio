      ...
      <section id="contact" className="py-16 px-6 md:px-10 mb-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
            {/* Email */}
            <a href="mailto:roeslimarvin@gmail.com" className="group p-8 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-2xl hover:bg-slate-700/80 hover:border-slate-600/70 transition-all duration-300 hover:scale-105 cursor-pointer block shadow-lg hover:shadow-xl hover:shadow-slate-900/20">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/arvinroeslim" target="_blank" rel="noopener noreferrer" className="group p-8 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-2xl hover:bg-slate-700/80 hover:border-slate-600/70 transition-all duration-300 hover:scale-105 cursor-pointer block shadow-lg hover:shadow-xl hover:shadow-slate-900/20">
            ...
            {/* GitHub */}
            <a href="https://github.com/arvinr11" target="_blank" rel="noopener noreferrer" className="group p-8 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-2xl hover:bg-slate-700/80 hover:border-slate-600/70 transition-all duration-300 hover:scale-105 cursor-pointer block shadow-lg hover:shadow-xl hover:shadow-slate-900/20">
